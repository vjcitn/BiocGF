...
filter_list = list("cell.type"=c("oligodendrocytes", "hybrid", "astrocytes", "OPC", "microglia",
...
get_gf_emb_cellcl = function(finepath, 
   ...
   emb_layer = 0L, emb_labels = c("tissue", "cell.type"), 
   labels_to_plot = "tissue", forward_batch_size = 100L, nproc = 16L) {
 ...
 basilisk::basiliskRun(proc, function(finepath, dataset_path, output_path,
    ...
    sampvals = lapply(emb_labels, function(x) dsref[[x]])
...
lkemb = get_gf_emb_cellcl( finepath=finepath, dataset_path=dataset_path, 
