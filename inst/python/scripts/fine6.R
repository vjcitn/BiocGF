...
output_prefix = "full_heart"
output_dir = "/media/volume/boot-vol-vince_12apr/vjcjul14heartb"
...
cl_inst = setup_and_run_Classifier(
  ...
  max_ncells=NULL, freeze_layers=2L, num_crossval_splits=1L,
  forward_batch_size=100L, nproc=16L, base_model_dir=model_dir_30M,
